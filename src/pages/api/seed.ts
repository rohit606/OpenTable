  ...
  await prisma.item.createMany({
    data: [
      ...
      },
      {
        ...
        price: "$12.00",
        restraunt_id: lastTrainToDelhiId,
      },
      {
      ...
      },
      {
        ...
        price: "$8.99",
        restraunt_id: kamasutraIndianId,
      },
      {
